...
echo "<hr>";
echo "Estou cursando $curso na Impacta";//iterpolação de variável

echo "<hr>";
echo 'Estou cursando '.$curso.' na Impacta';//concatenação

echo "<hr>";
echo "O conteúdo da variável \$curso é $curso";
